...
unsigned char gear[8][3] = {"NU","G1","G2","G3","G4","G5","RE ","CC"};
...
void view_dashboard(void)
{
    clcd_print((unsigned char *)"TIME    EVENT SP", (0x80 + (0)));
    get_time();
    get_speed();
    get_gear();
...
void view_log(void)
{
    ...
    if(count > 0)
    {
        ...
        if(key == 1 || key == 2)
        {
            ...
            clcd_print("                ",(0x80 + (0)));
            clcd_print("LOG DETAILS",(0x80 + (3)));
            clcd_print("                ",(0xC0 + (0)));
            clcd_print(log,(0xC0 + (0)));
...
void clear_log(void)
{
    ...
    {
        clcd_print("                ",(0x80 + (0)));
        clcd_print("LOG IS CLEATRED",(0xC0 + (0)));
        clcd_print("                ",(0xC0 + (0)));
    }
...
void set_time(void)
{
    ...
    if(init_flag == 0)
    {
        unsigned char hr = read_ds1307(0x02);
        unsigned char min = read_ds1307(0x01);
        unsigned char sec = read_ds1307(0x00);


        set_time[0] = ((hr >> 4) * 10) + (hr & 0x0F);
    ...
    if(key == 11)
    {
        write_ds1307(0x02, ((set_time[0] / 10) << 4) | (set_time[0] % 10));
        write_ds1307(0x01, ((set_time[1] / 10) << 4) | (set_time[1] % 10));
        write_ds1307(0x00, ((set_time[2] / 10) << 4) | (set_time[2] % 10));
