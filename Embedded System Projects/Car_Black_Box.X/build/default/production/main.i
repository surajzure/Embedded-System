...
void main(void)
{
    ...
    while(1)
    {
            ...
            if(key == 10)
            {
                    ...
                    {
                        state = e_password;
                        clcd_print("PASSWORD SCREEN",(0x80 + (0)));
                    }
                    else
                    {
                        state = e_dashboard;
            ...
            switch (state)
            {
                    ...
                    case e_password:
                        ...
                        else
                        {
                            ...
                            user_password[8]='\0';
                            if(my_strcmp(original_password,user_password)==0)
                             {
                                      clear_screen();
                                      state = e_main_menu;
                              }
                             else
                             {
                                attempts++;
                                clcd_print("                ", (0x80 + (0)));
                                clcd_print("WRONG PASSWD",(0x80 + (0)));

                                clcd_putch('0' + (5 - attempts), (0xC0 + (0)));
                                clcd_print("ATTEMPTS LEFT", (0xC0 + (1)));
                                if(attempts == 5)
                                {
                                     _delay((unsigned long)((1500)*(20000000/4000.0)));
                                    clcd_print("                ", (0x80 + (0)));
                                    clcd_print("SYSTEM LOCKED",(0x80 + (0)));
                                    clcd_print("                ", (0xC0 + (0)));
                                    clcd_print("RESET BOARD",(0xC0 + (0)));
                                    while(1);
